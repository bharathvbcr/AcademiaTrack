                                                    ...
                                                    <tr key={draft.id} className="bg-white dark:bg-slate-800 border-b dark:border-slate-700">
                                                                ...
                                                                {draft.filePath ? (
                                                                    <>
                                                                        <button
                                                                            ...
                                                                            title="Open file"
                                                                            aria-label={`Open draft file for ${essay.name} version ${draft.version}`}
                                                                        >
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            title="Remove file"
                                                                            aria-label={`Remove file for ${essay.name} version ${draft.version}`}
                                                                        >
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        title="Attach file"
                                                                        aria-label={`Attach file for ${essay.name} version ${draft.version}`}
                                                                    >
                                                        ...
                                                        <td className="px-4 py-2">
                                                            <button
                                                                ...
                                                                aria-label={`Delete ${essay.name} version ${draft.version}`}
                                                            >
                                ...
                                <div className="bg-slate-100 dark:bg-slate-700/30 p-3 rounded-lg border border-dashed border-slate-300 dark:border-slate-600">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                                        <input
                                            ...
                                            aria-label="Draft version number"
                                        />
                                        <input
                                            type="date"
